...
<#--            <#list test.quizzes as quiz>-->
            ...
            <div class="card mb-3 shadow p-3 mb-5 bg-white rounded" id="${test.id}">
                <#--<div class="m-2">
                ...
                <div   style="display: inline-flex" >
                    ...
                    <form method="get" action="/api/quizzes/${test.id?c}/info/" class="form-inline ml-2 mr-2">
<#--                        <button type="submit" class="btn btn-primary ml-2 my-1">Подробнее</button>-->
                    ...
                    <form method="get" action="/update/${test.id?c}" class="form-inline mr-2">
                        <button type="submit" class="btn btn-primary ml-2 my-1">
                    ...
                    <form class="form-inline mr-2">
                        <button onclick="deleteQuiz(${test.id?c})" type="submit" class="btn btn-primary ml-2 my-1">
