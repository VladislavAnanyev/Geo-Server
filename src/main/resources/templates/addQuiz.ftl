...
<@c.page>
    ...
    <div id="1Id" class="quiz">
        ...
        <div class="custom-control custom-checkbox mt-2" id="1Id2" >
            ...
            <button onclick="removeOptions(1,2)" class="btn btn-primary mt-3 1butt">Удалить вариант</button>
        </div>
        ...
        <div class="custom-control custom-checkbox mt-2" id="1Id3">
            ...
            <button onclick="removeOptions(1,3)" class="btn btn-primary mt-3 1butt">Удалить вариант</button>
        </div>
        ...
        <div id="1Id4" class="custom-control custom-checkbox mt-2" >
            ...
            <button onclick="removeOptions(1,4)" class="btn btn-primary mt-3 1butt">Удалить вариант</button>
        </div>
